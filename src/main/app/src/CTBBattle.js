    ...
    render() {
        ...
        return (
            <div>
                ...
                <div class="wrapper">
                    <div class="box a11" id="a11"><Button style={{ height: "100%", width: "100%" }} color="primary" disabled={this.state.A1 === '1' || this.state.A1C === '1' || this.state.A1C === '2'} onClick={() => this.setA1('1')}><p>{this.namearr[0]}</p><p>{this.namearr[1]}</p></Button></div>
                    <div class="box a12" id="a12"><Button style={{ height: "100%", width: "100%" }} color="primary" disabled={this.state.A1 === '2' || this.state.A1C === '1' || this.state.A1C === '2'} onClick={() => this.setA1('2')}>{this.namearr[1]} + "\n" +{this.namearr[2]} + "\n" +{this.namearr[3]}</Button></div>
